import type { Team, JudgeScores, BadgeId, TournamentCategory, TournamentTier, WeekId, TeamMember } from "./types";

const TOURNAMENT_CATALOG: Array<{ category: TournamentCategory; tiers: TournamentTier[] }> = [
  { category: "Custom AI Challenge", tiers: ["C Seviye AI Asistan Oluşturma > Custom Level-1", "B Seviye AI Asistan Oluşturma > Custom Level-2", "A Seviye AI Asistan Oluşturma > Custom Level-3"] },
  { category: "Prototype Challenge", tiers: ["C Seviye İş Fikrini Modelleme > MVP Level-1", "B Seviye İş Fikrini Modelleme > MVP Level-2", "A Seviye İş Fikrini Modelleme > MVP Level-3"] },
  { category: "Agent Challenge", tiers: ["C Seviye AI Ajan Geliştirme > Agent Level-1", "B Seviye AI Ajan Geliştirme > Agent Level-2", "A Seviye AI Ajan Geliştirme > Agent Level-3"] },
  { category: "APP Challenge", tiers: ["C Seviye APP Geliştirme > APP Level-1", "B Seviye APP Geliştirme > APP Level-2", "A Seviye APP Geliştirme > APP Level-3"] },
  { category: "BİG Wiser Challenge", tiers: ["C Seviye Girişim Geliştirme > İnnovation Level-1", "B Seviye Girişim Geliştirme > İnnovation Level-2", "A Seviye Girişim Geliştirme > İnnovation Level-3"] },
];
